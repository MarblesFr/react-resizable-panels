...
import { Panel, PanelGroup, PanelGroupStorage } from "react-px-resizable-panels";
  ...
  return (
    <div className={styles.PanelGroupWrapper}>
      <PanelGroup
        ...
        storage={urlStorage}
      >
        <Panel className={styles.PanelRow} collapsible={true} collapsedSize={20} minSize={80} defaultSize={100}>
          <div className={styles.Centered}>left</div>
        </Panel>
        <ResizeHandle className={styles.ResizeHandle} />
        <Panel className={styles.PanelRow} minSize={10} defaultSize='*'>
